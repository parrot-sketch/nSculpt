  ...
  return (
    <aside className="w-72 bg-brand-teal h-full flex flex-col shadow-2xl relative z-20">
      ...
      <div className="p-6 border-t border-white/5">
        <button
          onClick={() => logout()}
          className="w-full flex items-center gap-4 px-5 py-4 text-sm font-semibold text-white/40 hover:text-white hover:bg-white/5 rounded-xl transition-all group"
        >
          <LogOut className="h-5 w-5 text-white/20 group-hover:text-white/60 transition-colors" />
          <span>Sign Out</span>
        </button>
      </div>
    </aside>
